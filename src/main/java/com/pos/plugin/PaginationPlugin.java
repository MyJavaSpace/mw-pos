...
public class PaginationPlugin extends PluginAdapter {
	...
	public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass,
		...
		FullyQualifiedJavaType fqjt = new FullyQualifiedJavaType(
				"BaseDao<" + introspectedTable.getBaseRecordType() + ","+introspectedTable.getPrimaryKeyType()+">");
		FullyQualifiedJavaType imp = new FullyQualifiedJavaType("com.pos.base.BaseDao");
	 ...
	 */
	/*
	 * @Override public boolean modelGetterMethodGenerated(Method method,
	 * TopLevelClass topLevelClass, IntrospectedColumn introspectedColumn,
	 * IntrospectedTable introspectedTable ) return true; }
	 */
